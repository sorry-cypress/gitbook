...
- Sorry Cypress is now able to detect stale runs and properly report RUN_FINISH hook using I[nactivity Timeout.](../concepts/inactivity-timeout.md) That includes. more complex cases when multiple spec groups involved.
